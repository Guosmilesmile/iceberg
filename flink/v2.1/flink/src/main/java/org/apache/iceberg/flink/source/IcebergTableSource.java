...
public class IcebergTableSource
  ...
  private final @Nullable LookupOptions.LookupCacheType lookupCacheType;
  ...
  private IcebergTableSource(IcebergTableSource toCopy) {
    ...
    this.lookupCacheType = toCopy.lookupCacheType;
  }
  ...
  public IcebergTableSource(
    ...
    this(
        ...
        cache,
        null,
        cache != null ? LookupOptions.LookupCacheType.PARTIAL : LookupOptions.LookupCacheType.NONE);
  }
  ...
  private IcebergTableSource(
      ...
      @Nullable LookupCache cache,
      @Nullable Duration refreshInterval,
      @Nullable LookupOptions.LookupCacheType lookupCacheType) {
    this.loader = loader;
    this.schema = schema;
    ...
    this.lookupCacheType = lookupCacheType;
  }
  ...
  public LookupRuntimeProvider getLookupRuntimeProvider(LookupContext context) {
    ...
    if (lookupCacheType == LookupOptions.LookupCacheType.PARTIAL) {
    ...
    } else if (lookupCacheType == LookupOptions.LookupCacheType.FULL) {
      LookupFunction lookupFn =
